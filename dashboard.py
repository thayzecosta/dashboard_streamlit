...
regioes = ['Brasil', 'Centro-Oeste', 'Nordeste', 'Norte',
           'Sudeste', 'Sul']

# Barra lateral - Filtragem
...
if todos_anos:
    ...
    st.sidebar.slider('Ano', 2020, 2023)
...
## Tabelas
### Tabelas de receita
receita_estados = dados.groupby(
    'Local da compra')[['Preço']].sum()
...
with aba1:
    ...
    with coluna2:
        st.metric('Quantidade de vendas', formata_numero(dados.shape[0], 'R$'))
